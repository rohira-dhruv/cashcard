...
class CashcardApplicationTests {
	...
	void shouldCreateANewCashCard() {
		...
		ResponseEntity<Void> createdResponse = restTemplate.postForEntity("/cashcards", newCashCard, Void.class);
		assertThat(createdResponse.getStatusCode()).isEqualTo(HttpStatus.CREATED);

		URI locationOfNewCashCard = createdResponse.getHeaders().getLocation();
